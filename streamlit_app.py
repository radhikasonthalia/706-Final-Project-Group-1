...
st.set_page_config(page_title="Vaccination Dashboards", layout="wide")

# Sidebar for page selection
st.sidebar.title("Navigation")
page = st.sidebar.radio("Select a visualization:", 
                        ["Visualization 1", "Visualization 2", "Vaccination Coverage"])

# -------------------------------------------------------------------------
# Visualization 1
# -------------------------------------------------------------------------
if page == "Visualization 1":
    st.header("Visualization 1")

    ### PASTE CODE FOR VISUALIZATION 1 HERE ###
    ### should end in  st.altair_chart(dashboard)###
    pass #delete this once you add your code
...
# -------------------------------------------------------------------------
    ...
    ### PASTE CODE FOR VISUALIZATION 2 HERE ###
    ### should end in st.altair_chart(dashboard) ###
    pass #delete this once you add your code

# -------------------------------------------------------------------------
# Vaccination Coverage Visualization (prefilled with my immunization.py)
# -------------------------------------------------------------------------
